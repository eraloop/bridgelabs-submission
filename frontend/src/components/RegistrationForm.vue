...
<template>
  <div class="d-flex justify-content-center align-items-center mx-auto">
    <div class="form-region shadow-lg my-4">
        ...
        <div class="form-section col-sm-12 col-md-12 d-flex-column justify-content-center align-items-center  px-4">
            <section class="google-btn  d-flex align-items-center justify-content-center pt-4 pb-2">
                <button class="d-flex align-items-center outline justify-content-center  col-8 text-center px-5 py-2">
